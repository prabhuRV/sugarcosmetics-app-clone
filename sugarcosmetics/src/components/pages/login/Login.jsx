  ...
  return (
    ...
    <div id= {styles.slide}>
       ...
       <div id = {styles.form}>
         ...
         <hr id= {styles.hr}/>
         <p id= {styles.digit}>Enter the 4 digit OTP received on your phone.</p>
   ...
   <div id= {styles.otpHold} >
     ...
     <div id={styles.condition}>
       ...
       <a  id={styles.terms} href="">Terms and Conditions</a>
     </div>

     <div id={styles.extra}>
          <p id={styles.p1}>Registering for this site allows you to access your order status and history. Just fill in the
      ...
      <div id={styles.extraInfo}>
            <p id={styles.p2}>By Signing up or logging in, you agree to our </p>
            <a href="" id={styles.terms2} >Terms and Conditions</a>
      </div>
